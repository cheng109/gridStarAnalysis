...
def plotChip(pointing_RA, pointing_DEC):
    side = 20
    x=[7.5, 7.5,4.5, 4.5,-4.5,-4.5,-7.5,-7.5,-4.5,-4.5,4.5,4.5,7.5,7.5]
    y=[0,4.5,4.5,7.5,7.5,4.5,4.5,-4.5,-4.5,-7.5,-7.5,-4.5,-4.5,0]
    x[:] = [20*i+pointing_RA for i in x]
    y[:] = [20*j+pointing_DEC for j in y]
    plt.plot(x,y)
    plt.axis('equal')
